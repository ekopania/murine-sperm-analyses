...
python /ix3/nclark/ekopania/MURINAE_REVISIONS/core/hyphy-interface/hyphy_gen.py -i /ix3/nclark/ekopania/MURINAE_REVISIONS/alns/ -m busted-ph -genetrees /ix3/nclark/ekopania/MURINAE_REVISIONS/GENE_TREES/ -o /ix3/nclark/ekopania/MURINAE_REVISIONS/HYPHY_busted-ph/OUfg_fullReproSet -tb OU_fgs.txt -p hyphy -part good_lab_cpu -tasks 64 -cpus 1 -mem 12000 -n OUfg_fullReproSet #-rb OU_bgs.txt
