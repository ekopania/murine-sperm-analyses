...
#Run hyphy_to_csv.py for GO spermatogenesis genes
python /ihome/nclark/emk270/software/core/hyphy-interface/hyphy_to_csv.py -i GOspermatogenesisProteins_OUfg_fullReproSet/ -m busted-ph -o busted-ph_output.GOspermatogenesisProteins_OUfg_fullReproSet.csv
