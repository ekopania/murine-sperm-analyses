...
library(topGO)
library(biomaRt)
source("/projects/ek112884e/murines_revisions/FROM_REDWOOD/RERconverge/MariaBarcodePlotFinal.R")

print("Reading in and formatting data...")
rhoMat<-c()
signedPMat<-c()
#Loop through all binary RERconverge runs for RTM
#RERrun<-c("_binary.RTMspeciesOnly", "_binary.q10.RTMspeciesOnly", "_binary.q20.RTMspeciesOnly", "_binary.q80.RTMspeciesOnly", "_binary.q90.RTMspeciesOnly", "")
#Just lower RTM and continuous
#RERrun<-c("_binary.RTMspeciesOnly", "_binary.q10.RTMspeciesOnly", "_binary.q20.RTMspeciesOnly", "_binary.q50low.RTMspeciesOnly", "")
...
LZ_prot<-scan("/projects/ek112884e/murines_revisions/FROM_REDWOOD/DNDS_BY_SPERM_STAGE/HYPHY/SLAC/prot_list_LZinduced_edgeR_wholeGenome.ensemblOrthos.txt", what=character())
RS_prot<-scan("/projects/ek112884e/murines_revisions/FROM_REDWOOD/DNDS_BY_SPERM_STAGE/HYPHY/SLAC/prot_list_RSinduced_edgeR_wholeGenome.ensemblOrthos.txt", what=character())
TS_prot<-scan("/projects/ek112884e/murines_revisions/FROM_REDWOOD/DNDS_BY_SPERM_STAGE/HYPHY/SLAC/prot_list_testisSpecific.txt", what=character())
som_prot<-scan("/projects/ek112884e/murines_revisions/FROM_REDWOOD/REPRO_PROTEIN_LISTS/prot_list.greenEtal2018.somatic.txt", what=character())
spg_prot<-scan("/projects/ek112884e/murines_revisions/FROM_REDWOOD/REPRO_PROTEIN_LISTS/prot_list.greenEtal2018.spermatogonia.txt", what=character())
pre_prot<-scan("/projects/ek112884e/murines_revisions/FROM_REDWOOD/REPRO_PROTEIN_LISTS/prot_list.greenEtal2018.prelep.txt", what=character())
spc_prot<-scan("/projects/ek112884e/murines_revisions/FROM_REDWOOD/REPRO_PROTEIN_LISTS/prot_list.greenEtal2018.spermatocytes.txt", what=character())
spt_prot<-scan("/projects/ek112884e/murines_revisions/FROM_REDWOOD/REPRO_PROTEIN_LISTS/prot_list.greenEtal2018.spermatids.txt", what=character())
elo_prot<-scan("/projects/ek112884e/murines_revisions/FROM_REDWOOD/REPRO_PROTEIN_LISTS/prot_list.greenEtal2018.elongating.txt", what=character())
bd_prot<-scan("/projects/ek112884e/murines_revisions/FROM_REDWOOD/REPRO_PROTEIN_LISTS/prot_list.BD.any.txt", what=character())
bu_prot<-scan("/projects/ek112884e/murines_revisions/FROM_REDWOOD/REPRO_PROTEIN_LISTS/prot_list.BU.any.txt", what=character())
cg_prot<-scan("/projects/ek112884e/murines_revisions/FROM_REDWOOD/REPRO_PROTEIN_LISTS/prot_list.CG.any.txt", what=character())
dp_prot<-scan("/projects/ek112884e/murines_revisions/FROM_REDWOOD/REPRO_PROTEIN_LISTS/prot_list.DP.any.txt", what=character())
vp_prot<-scan("/projects/ek112884e/murines_revisions/FROM_REDWOOD/REPRO_PROTEIN_LISTS/prot_list.VP.any.txt", what=character())
sv_prot<-scan("/projects/ek112884e/murines_revisions/FROM_REDWOOD/REPRO_PROTEIN_LISTS/prot_list.SV.any.txt", what=character())
...
source("/projects/ek112884e/murines_revisions/FROM_REDWOOD/RERconverge/MariaBarcodePlotFinal.colorBySelec.R")
relax<-read.csv("relax_output.OUfg_paredSet_noOutgroups.BHcorrection.sigOnly.relaxedOnly.csv", header=TRUE)
#ps<-read.table("/uufs/chpc.utah.edu/common/HIPAA/u6035720/MURINAE/DNDS_BY_SPERM_STAGE/PAML/pos_selec.pValCor.sigOnly.posOnly.m1aVm2a.txt", header=TRUE)
#bs<-read.table("/uufs/chpc.utah.edu/common/HIPAA/u6035720/MURINAE/DNDS_BY_SPERM_STAGE/PAML/pos_selec.pValCor.sigOnly.posOnly.txt", header=TRUE)
...
pdf("enrichment_density.OUmodel.span0_2.withSelection.pdf", height=7, width=10, onefile=TRUE)
#myCol<-c("#CCCCCC", "#028090", "#3E4768", "#984447", "#000000")
...
print(GO_spermatogenesis_relaxed)
...
write(GO_spermatogenesis, file="GO_spermatogenesis_genes.txt")
