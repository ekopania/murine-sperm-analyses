...
#Run hyphy_to_csv.py
python /ix3/nclark/ekopania/MURINAE_REVISIONS/core/hyphy-interface/hyphy_to_csv.py -i GOspermatogenesisProteins_OUfg_fullReproSet/ -m relax -o relax_output.GOspermatogenesisProteins_OUfg_fullReproSet.csv
