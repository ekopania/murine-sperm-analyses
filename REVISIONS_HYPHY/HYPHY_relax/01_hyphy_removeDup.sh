...
#for dir in /ix3/nclark/ekopania/MURINAE_REVISIONS/HYPHY_relax/OUfg_fullReproSet_CPU1/*filter; do
for dir in /ix3/nclark/ekopania/MURINAE_REVISIONS/HYPHY_relax/OUfg_fullReproSet_CPU1/ENSMUSP00000000028-mafft-cds.filter; do
	#Remove duplicate sequences
	hyphy /ihome/nclark/emk270/software/hyphy-analyses/remove-duplicates/remove-duplicates.bf --msa ${dir}/relax.fa --tree ${dir}/relax.tre --output ${dir}/uniques.fa ENV="DATA_FILE_PRINT_FORMAT=9"
