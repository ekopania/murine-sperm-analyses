...
#python /ix3/nclark/ekopania/MURINAE_REVISIONS/core/hyphy-interface/hyphy_gen.py -i /ix3/nclark/ekopania/MURINAE_REVISIONS/alns/ -m busted -genetrees /ix3/nclark/ekopania/MURINAE_REVISIONS/GENE_TREES/ -o /ix3/nclark/ekopania/MURINAE_REVISIONS/HYPHY_busted/OUfg_fullReproSet -p hyphy -part good_lab_cpu -tasks 64 -cpus 1 -mem 12000 -n OUfg_fullReproSet #-rb OU_bgs.txt

#WITHOUT SRV and MNMs
#python /ix3/nclark/ekopania/MURINAE_REVISIONS/core/hyphy-interface/hyphy_gen.py -i /ix3/nclark/ekopania/MURINAE_REVISIONS/alns/ -m busted -genetrees /ix3/nclark/ekopania/MURINAE_REVISIONS/GENE_TREES/ -o /ix3/nclark/ekopania/MURINAE_REVISIONS/HYPHY_busted/OUfg_fullReproSet_noSRV_noMNM -srv False -mns None -p hyphy -part good_lab_cpu -tasks 64 -cpus 1 -mem 12000 -n OUfg_fullReproSet_noSRV_noMNM

#WITH SRV but WITHOUT MNMs
python /ihome/nclark/emk270/software/core/hyphy-interface/hyphy_gen.py -i /ix3/nclark/ekopania/MURINAE_REVISIONS/alns/ -m busted -genetrees /ix3/nclark/ekopania/MURINAE_REVISIONS/GENE_TREES/ -o /ix3/nclark/ekopania/MURINAE_REVISIONS/HYPHY_busted/OUfg_fullReproSet_yesSRV_noMNM -srv True -mns None -p hyphy -part good_lab_cpu -tasks 64 -cpus 1 -mem 12000 -n OUfg_fullReproSet_yesSRV_noMNM
