#!/bin/bash
#PURPOSE: Get protein IDs that correspond to exome capture targeted regions using mouse GTF file; append to bedfile
#
# Job name:
#SBATCH --job-name=append_targeted_proteins
#SBATCH --output=append_targeted_proteins-%j.log
